...
public final class ActivityMessagesBinding implements ViewBinding {
  ...
  private ActivityMessagesBinding(@NonNull LinearLayout rootView, @NonNull FrameLayout contentFrame,
  ...
  public static ActivityMessagesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMessagesBinding((LinearLayout) rootView, contentFrame, tabLayout, toolbar);
    }
